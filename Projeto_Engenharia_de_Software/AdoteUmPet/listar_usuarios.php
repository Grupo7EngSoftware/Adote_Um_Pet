...
<head>
	...
	<div class="container">
		...
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Lista de usuarios</strong> <a href="cadastrar_usuarioForm.php?" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Adicionar usuario</a></div>
			<div class="card-body">
		</div>
	<meta charset="UTF-8">
